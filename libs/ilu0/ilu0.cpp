...
static inline void gather_blocks_avx256(
    __m256d dst[BS2],
    const double *blocks,
    __m256i offsets,
    __mmask8 mask
...
static inline void scatter_blocks_avx256(
    double *blocks,
...
static inline void matmat_avx256(__m256d dst[BS2], const __m256d A[BS2], const __m256d B[BS2])
{
...
static inline void matsub_avx256(__m256d dst[BS2], const __m256d A[BS2], const __m256d B[BS2])
{
    for (int reg = 0; reg < BS2; reg++) {
...
static inline void process_blocks_avx256(
    double *blocks,
...
static inline void gather_blocks_hwy256(
...
static inline void scatter_blocks_hwy256(
    double *blocks,
...
static inline void matmat_hwy256(
    hn::Vec<hn::FixedTag<double, 4>> dst[BS2],
...
static inline void matsub_hwy256(
    hn::Vec<hn::FixedTag<double, 4>> dst[BS2],
    const hn::Vec<hn::FixedTag<double, 4>> A[BS2],
    const hn::Vec<hn::FixedTag<double, 4>> B[BS2]
)
...
static inline void process_blocks_hwy256(
    double *blocks,
    const double *block_ik,
    const int64_t *offsets_i,
    const int64_t *offsets_k,
